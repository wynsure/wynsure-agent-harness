...
// Connection is established eagerly at session instantiation, mirroring
// McpStdio / McpDenoWorker. Auth: `none` | `apiKey` (bearer) | `oauth`
// (client_credentials). Connection fields support `{{env.*}}` templates
// resolved against the process env.
