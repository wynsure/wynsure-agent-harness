 ...
 * has NO runtime footprint of its own â€” it never exposes tools, never
...
export class PresetObject implements ResourceObject, PresetView {
   ...
   /** Typed discriminator â€” a preset exposes itself as a `PresetView`. */
   asPreset(): PresetView {
      return this
   }
...
scheme.register({
   ...
   metadata: {
      role: "Conteneur de mutualisation ; inert tant qu'il n'est pas Ã©tendu via `extends`.",
